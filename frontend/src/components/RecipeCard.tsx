...
export function RecipeCard({ recipe, badge }: Props) {
  return (
    <Link
      ...
      className="focus-ring group flex flex-col overflow-hidden rounded-2xl border border-sand bg-white/60 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
    >
